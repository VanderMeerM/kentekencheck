...
<input class='licenseplate' type="text" id="lp" name="lp"> 
...
<script>
    document.getElementById('lp').addEventListener('keydown', () => {
        let enteredWord = document.getElementById('lp').value;
       if ( enteredWord.length >= 8) {
        console.log('te veel');
       };
    })
</script>
